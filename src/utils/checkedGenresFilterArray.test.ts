...
it('should return an array corresponding to genre checked items', () => {
  const checkedItems = ['classic rock', 'pop'];
  ...
  const result = checkedGenresFilterArray(checkedItems, data);
