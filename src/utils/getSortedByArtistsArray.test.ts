import { getSortedByArtistsArray } from './getSortedByArtistsArray';

it('should sort an array by artist in the ascending order', () => {
  const dataArray = [
    {
  ...
  const result = getSortedByArtistsArray(dataArray);
